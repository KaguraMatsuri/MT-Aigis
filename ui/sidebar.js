(function () {
  ...
  var i18n = {
    zh: {
      ...
      cancel: '取消',
      save: '保存',
      legacyTitle: '检测到旧版明文密码',
      legacyCopy: '可以导入到当前 macOS 用户目录。项目目录仍不会进入安装包。',
      legacyImport: '导入旧版密码',
      clearFailed: '清除失败',
      saved: '已保存',
      imported: '已导入',
    ...
    en: {
      ...
      clientTitle: 'Millennium War Aigis',
      back: 'Back',
      reload: 'Reload',
      next: 'Next',
      ...
      author: 'Author',
      contact: 'Contact',
      gameName: 'Millennium War Aigis macOS Client',
      ...
      cancel: 'Cancel',
      save: 'Save',
      legacyTitle: 'Legacy plaintext vault found',
      legacyCopy: 'Import it into the current macOS user folder. Project files are still excluded from builds.',
    ...
    ja: {
      ...
      cancel: 'キャンセル',
      save: '保存',
      legacyTitle: '旧形式の平文パスワードを検出',
      legacyCopy: '現在の macOS ユーザーフォルダへ取り込めます。プロジェクトフォルダはビルドに入りません。',
